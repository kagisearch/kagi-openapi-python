...
class TestSearchRequestPersonalizations(unittest.TestCase):
    """SearchRequestPersonalizations unit test stubs"""
    ...
    def make_instance(self, include_optional) -> SearchRequestPersonalizations:
        """Test SearchRequestPersonalizations
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `SearchRequestPersonalizations`
        """
        model = SearchRequestPersonalizations()
        if include_optional:
            return SearchRequestPersonalizations(
                domains = [
    ...
    def testSearchRequestPersonalizations(self):
        """Test SearchRequestPersonalizations"""
