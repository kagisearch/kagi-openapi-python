...
class TestSearchResultImage(unittest.TestCase):
    """SearchResultImage unit test stubs"""
    ...
    def make_instance(self, include_optional) -> SearchResultImage:
        """Test SearchResultImage
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `SearchResultImage`
        """
        model = SearchResultImage()
        if include_optional:
    ...
    def testSearchResultImage(self):
        """Test SearchResultImage"""
