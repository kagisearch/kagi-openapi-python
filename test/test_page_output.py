...
class TestPageOutput(unittest.TestCase):
    """PageOutput unit test stubs"""
    ...
    def make_instance(self, include_optional) -> PageOutput:
        """Test PageOutput
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `PageOutput`
        """
        model = PageOutput()
        if include_optional:
            return PageOutput(
