...
class TestSearchRequestExtract(unittest.TestCase):
    """SearchRequestExtract unit test stubs"""
    ...
    def make_instance(self, include_optional) -> SearchRequestExtract:
        """Test SearchRequestExtract
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `SearchRequestExtract`
        """
        model = SearchRequestExtract()
        if include_optional:
            return SearchRequestExtract(
                count = 1,
                timeout = 0.5
            )
        else:
    ...
    def testSearchRequestExtract(self):
        """Test SearchRequestExtract"""
