...
class TestSearchRequestPersonalizationsRegexesInner(unittest.TestCase):
    """SearchRequestPersonalizationsRegexesInner unit test stubs"""
    ...
    def make_instance(self, include_optional) -> SearchRequestPersonalizationsRegexesInner:
        """Test SearchRequestPersonalizationsRegexesInner
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `SearchRequestPersonalizationsRegexesInner`
        """
        model = SearchRequestPersonalizationsRegexesInner()
        if include_optional:
            return SearchRequestPersonalizationsRegexesInner(
                regex = '',
                replacement = ''
            )
        else:
    ...
    def testSearchRequestPersonalizationsRegexesInner(self):
        """Test SearchRequestPersonalizationsRegexesInner"""
