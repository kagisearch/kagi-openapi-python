...
class TestSearchRequestPersonalizationsDomainsInner(unittest.TestCase):
    """SearchRequestPersonalizationsDomainsInner unit test stubs"""
    ...
    def make_instance(self, include_optional) -> SearchRequestPersonalizationsDomainsInner:
        """Test SearchRequestPersonalizationsDomainsInner
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `SearchRequestPersonalizationsDomainsInner`
        """
        model = SearchRequestPersonalizationsDomainsInner()
        if include_optional:
            return SearchRequestPersonalizationsDomainsInner(
                domain = '',
                bias = 1.337
            )
        else:
    ...
    def testSearchRequestPersonalizationsDomainsInner(self):
        """Test SearchRequestPersonalizationsDomainsInner"""
