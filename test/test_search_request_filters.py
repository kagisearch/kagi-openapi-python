...
class TestSearchRequestFilters(unittest.TestCase):
    """SearchRequestFilters unit test stubs"""
    ...
    def make_instance(self, include_optional) -> SearchRequestFilters:
    ...
    def testSearchRequestFilters(self):
        """Test SearchRequestFilters"""
