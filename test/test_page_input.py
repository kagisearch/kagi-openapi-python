...
class TestPageInput(unittest.TestCase):
    """PageInput unit test stubs"""
    ...
    def make_instance(self, include_optional) -> PageInput:
        """Test PageInput
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `PageInput`
        """
        model = PageInput()
        if include_optional:
            return PageInput(
