...
class SearchResult(BaseModel):
    ...
    """ # noqa: E501
    url: StrictStr = Field(description="The location of the result. This is the direct URL to the resource that matches the query", json_schema_extra={"examples": ["https://en.wikipedia.org/wiki/Steve_Jobs"]})
    title: StrictStr = Field(description="This is the title of the resource. For HTML documents, it reflects `<title>`. For videos, it is the name that would be displayed on the video site.", json_schema_extra={"examples": ["Steve Jobs - Wikipedia"]})
    snippet: Optional[StrictStr] = Field(default=None, description="A short summary of the contents of the resource", json_schema_extra={"examples": ["Steven Paul Jobs (February 24, 1955 – October 5, 2011) was an American businessman, inventor, and investor best known for co-founding the ..."]})
    time: Optional[StrictStr] = Field(default=None, description="The date when the resource was created or last updated.", json_schema_extra={"examples": ["2024-11-29T03:54:26Z"]})
