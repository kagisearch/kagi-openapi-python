...
class PageInput(BaseModel):
    ...
    """ # noqa: E501
    url: StrictStr = Field(description="The HTTPS URL of the page to extract content from. Must use HTTPS scheme with a valid host. ", json_schema_extra={"examples": ["https://example.com/article"]})
