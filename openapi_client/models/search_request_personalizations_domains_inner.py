...
class SearchRequestPersonalizationsDomainsInner(BaseModel):
    ...
    """ # noqa: E501
    domain: StrictStr = Field(description="Domain pattern to personalize (e.g., \"example.com\"). Can also be a tld suffix like \".co.uk\".")
    kind: StrictStr = Field(description="Handling mode for this domain pattern")
    __properties: ClassVar[List[str]] = ["domain", "kind"]
