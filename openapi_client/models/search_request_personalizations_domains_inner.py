...
class SearchRequestPersonalizationsDomainsInner(BaseModel):
    """
    SearchRequestPersonalizationsDomainsInner
    """ # noqa: E501
    domain: Optional[StrictStr] = Field(default=None, description="The domain to personalize (e.g., \"example.com\").")
    bias: Optional[Union[StrictFloat, StrictInt]] = Field(default=None, description="Bias value to apply to results from this domain.")
    __properties: ClassVar[List[str]] = ["domain", "bias"]
