...
class ErrorDetail(BaseModel):
    ...
    """ # noqa: E501
    code: StrictStr = Field(description="Namespaced error code", json_schema_extra={"examples": ["extract.invalid_url"]})
    url: StrictStr = Field(description="URL to error documentation", json_schema_extra={"examples": ["https://help.kagi.com/api/errors#extract.invalid_url"]})
    message: Optional[StrictStr] = Field(default=None, description="Human-readable error message", json_schema_extra={"examples": ["URL must be a valid HTTPS URL"]})
    location: Optional[StrictStr] = Field(default=None, description="Field location where the error occurred", json_schema_extra={"examples": ["pages[0].url"]})
    __properties: ClassVar[List[str]] = ["code", "url", "message", "location"]
