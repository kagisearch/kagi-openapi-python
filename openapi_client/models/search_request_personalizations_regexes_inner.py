...
class SearchRequestPersonalizationsRegexesInner(BaseModel):
    """
    SearchRequestPersonalizationsRegexesInner
    """ # noqa: E501
    regex: Optional[StrictStr] = Field(default=None, description="The regex pattern to match.")
    replacement: Optional[StrictStr] = Field(default=None, description="The replacement string to apply when the pattern matches. Will preserve paths and query parameters if not overwritten. You can refer to capture groups with \"$1\", \"$2\", etc.")
    __properties: ClassVar[List[str]] = ["regex", "replacement"]
