...
class PageOutput(BaseModel):
    ...
    """ # noqa: E501
    url: StrictStr = Field(description="The URL of the extracted page", json_schema_extra={"examples": ["https://example.com/article"]})
    markdown: Optional[StrictStr] = Field(default=None, description="Extracted markdown content of the page", json_schema_extra={"examples": ["# Article Title\n\nThis is the extracted content..."]})
