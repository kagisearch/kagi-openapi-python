...
class SearchResultImage(BaseModel):
    ...
    """ # noqa: E501
    url: StrictStr = Field(description="This is a URL that links directly to the image that goes with the resources.", json_schema_extra={"examples": ["https://upload.wikimedia.org/wikipedia/commons/thumb/d/dc/Steve_Jobs_Headshot_2010-CROP_%28cropped_2%29.jpg/330px-Steve_Jobs_Headshot_2010-CROP_%28cropp    ed_2%29.jpg"]})
    height: Optional[StrictInt] = Field(default=None, description="The height of the image.", json_schema_extra={"examples": [300]})
    width: Optional[StrictInt] = Field(default=None, description="The width of the image.", json_schema_extra={"examples": [310]})
